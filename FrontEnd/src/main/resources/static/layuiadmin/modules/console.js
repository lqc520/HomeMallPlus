...
layui.define(function(exports){
  ...
  */
  ...
  layui.use(['admin', 'carousel'], function(){
    ...
    //查询用户增量
    $.ajax({
      url: layui.setter.adminUrl+'member/getIncrement',
      success:function (data) {
        //浏览器访问信息
        let browser = data['browserValue'];
        for(let i in browser){
          var d = eval('(' + browser[i] + ')');
          browserValue[i] = {value:d.value,name:d.name}
        }
