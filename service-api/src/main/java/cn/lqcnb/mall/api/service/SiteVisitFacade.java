...
import cn.lqcnb.mall.api.vo.VisitVO;
import cn.lqcnb.mall.common.utils.DateUtil;
...
//        ImmutablePair<String, String> uri = URIUtil.foramtUri(reqDTO.getUri());
        ...
        // 获取站点的访问记录
        VisitVO uriVisit = doVisit(reqDTO.getApp(), reqDTO.getUri(), reqDTO.getIp());
        VisitVO siteVisit;
        logger.debug("uriVisit:"+uriVisit);

        siteVisit = doVisit(reqDTO.getApp(), reqDTO.getUri(), reqDTO.getIp());
